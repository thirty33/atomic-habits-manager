...
/**
 * Moderator agent — Infrastructure adapter to the Laravel\Ai SDK.
 *
 * Stateless from the user's point of view: does NOT implement
 * HasUserId / HasAuditContext, so its invocation logs land with
 * user_id=null (system action, intentionally distinguishable in the
 * audit dashboard).
 */
final class ModeratorAgent implements Agent, HasTools
{
    use Promptable;
