...
/**
 * Raised when a guest user claims their account by filling in real name, email
 * and password over an existing user id (the guest-claim flow, D1).
 */
final class UserClaimedAccount extends DomainEvent
{
    ...
    {
        return 'identity.user_claimed_account';
    }
