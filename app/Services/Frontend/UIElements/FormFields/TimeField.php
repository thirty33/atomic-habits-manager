...
class TimeField implements Contracts\Field
{
    ...
    const CSS_FIELD_CLASS = 'block w-full bg-card border-0 px-3.5 py-[11px] rounded-lg text-[14.5px] font-mono text-ink-900 placeholder:text-ink-400 shadow-[inset_0_0_0_1px_rgb(var(--color-line-200))] focus:shadow-[inset_0_0_0_1.5px_rgb(var(--color-brand-700))] focus:outline-none focus:ring-0 transition-shadow disabled:opacity-60 disabled:cursor-not-allowed';
