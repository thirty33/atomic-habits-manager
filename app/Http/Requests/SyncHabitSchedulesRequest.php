...
class SyncHabitSchedulesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'schedules.*.end_time' => ['required', 'date_format:H:i', 'different:schedules.*.start_time'],
    ...
    public function messages(): array
    {
        return [
            ...
            'schedules.*.end_time.different' => 'La hora de fin no puede ser igual a la hora de inicio',
