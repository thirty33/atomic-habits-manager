                ...
                <div class="flex flex-col flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-3 px-4 py-3 border-b border-gray-200 bg-white flex-shrink-0">
                        ...
                        <button
                            ...
                            class="lg:hidden text-xs font-medium text-indigo-600 bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-full transition-colors"
                        >
                            Conversaciones
                        </button>
                    </div>
    ...
    <Teleport to="body">
        <Transition name="drawer">
            <div v-if="showMobileSidebar" class="fixed inset-0 z-50 lg:hidden">
                ...
                <div class="relative z-10 h-full w-72 bg-white shadow-xl flex flex-col">
                    <div class="px-4 py-3 border-b border-gray-200 flex items-center justify-between flex-shrink-0">
                        ...
                        <div class="flex items-center gap-2">
                            <button
                                ...
                                :disabled="isCreatingConversation"
                                class="flex items-center justify-center w-9 h-9 rounded-md text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors disabled:opacity-50"
                                title="Nueva conversación"
                            >
                            ...
                            <button
                                ...
                                class="flex items-center justify-center w-9 h-9 rounded-md text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
