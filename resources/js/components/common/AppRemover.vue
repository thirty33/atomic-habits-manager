...
<template>
    ...
    <div class="sm:ml-12 sm:pb-4 sm:flex sm:pl-4 gap-2">
        ...
        <button
            type="button"
            class="inline-flex w-full justify-center text-white bg-btn-secondary hover:bg-btn-secondary-hover focus:ring-4 focus:outline-none focus:ring-btn-secondary/30 font-medium rounded-lg text-sm px-4 py-2 text-center transition-colors sm:w-auto"
            @click="$emit('close')"
        >
            {{ textCancelButton }}
        </button>
